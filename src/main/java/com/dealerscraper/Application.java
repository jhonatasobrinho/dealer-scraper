...
import com.dealerscraper.infrastructure.component.evaluator.PointingWordsEvaluator;
...
public class Application {
    ...
    public static void main(String[] args) {
        ...
        final var evaluatorChain = new RegexEvaluator(new RatingEvaluator(new PointingWordsEvaluator(FILE_PATH)));
